...
class MyGUI:
    ...
    def __init__(self):
        ...
        self.cut_ideal = tk.Radiobutton(
            self.radio_frame,
            text="Ideal",
            value="Ideal",
            variable=self.cut_value,
            padx=10,
            pady=10,
            command=self.selection_cut,
        )
        self.cut_ideal.grid(row=0, column=1)
        self.cut_premium = tk.Radiobutton(
            self.radio_frame,
            text="Premium",
            value="Premium",
            variable=self.cut_value,
        ...
        self.cut_very_good = tk.Radiobutton(
            self.radio_frame,
            text="Very Good",
            value="Very_good",
            variable=self.cut_value,
        ...
        self.clarity_si1 = tk.Radiobutton(
            self.radio_frame,
            text="SI1",
            value="SI1",
            variable=self.clarity_value,
            padx=10,
            pady=10,
            command=self.selection_clarity,
        )
        self.clarity_si1.grid(row=2, column=1)
        self.clarity_si2 = tk.Radiobutton(
            self.radio_frame,
            text="SI2",
            value="SI2",
            variable=self.clarity_value,
        ...
        self.clarity_vs1 = tk.Radiobutton(
            self.radio_frame,
            text="VS1",
            value="VS1",
            variable=self.clarity_value,
        ...
        self.clarity_vs2 = tk.Radiobutton(
            self.radio_frame,
            text="VS2",
            value="VS2",
            variable=self.clarity_value,
        ...
        self.clarity_vvs1 = tk.Radiobutton(
            self.radio_frame,
            text="VVS1",
            value="VVS1",
            variable=self.clarity_value,
        ...
        self.clarity_vvs2 = tk.Radiobutton(
            self.radio_frame,
            text="VVS2",
            value="VVS2",
            variable=self.clarity_value,
        ...
        self.clarity_i1 = tk.Radiobutton(
            self.radio_frame,
            text="I1",
            value="I1",
            variable=self.clarity_value,
        ...
        self.clarity_if = tk.Radiobutton(
            self.radio_frame,
            text="IF",
            value="IF",
            variable=self.clarity_value,
        ...
        self.entry_carat = tk.Entry(
            self.text_fields_frame, insertwidth=2, textvariable=self.carat_value
        )
        ...
        self.entry_depth = tk.Entry(
            self.text_fields_frame, insertwidth=2, textvariable=self.depth_value
        )
        ...
        self.entry_table = tk.Entry(
            self.text_fields_frame, insertwidth=2, textvariable=self.table_value
        )
        ...
        self.entry_x = tk.Entry(
            self.text_fields_frame, insertwidth=2, textvariable=self.x_value
        )
        ...
        self.entry_y = tk.Entry(
            self.text_fields_frame, insertwidth=2, textvariable=self.y_value
        )
        ...
        self.entry_z = tk.Entry(
            self.text_fields_frame, insertwidth=2, textvariable=self.z_value
        )
        self.entry_z.grid(row=1, column=5)
        self.text_fields_frame.pack()
        self.send_button = tk.Button(
            self.root, text="price", padx=10, command=self.send
        )
